<div class="section fp-auto-height faqs-content">
	<div class="main-content">
		<div class="page-head"><h2>Membership FAQs</h2></div>
		
		<div class="col-md-8 center-block lead text-left">
			<h4><strong>What benefits do I get from joining ERS through a national society?</strong></h4>
			<p>If you join ERS through your national society, you will receive the full benefits of being an ERS member, including unrestricted access to ERS publications, webcasts, scientific content, and discounts to conferences and events.</p>

			<h4><strong>If I’m already a member of ERS, do I need to cancel my existing membership?</strong></h4>
			<p>No. Your membership data will be automatically updated and your ERS membership fees will be included in the national society’s membership fee.</p>

			<h4><strong>If I’m already a member of ERS, will I need new login details to access ERS material?</strong></h4>
