          ...
          <div class="main-content">
            ...
            <div class="row">
                <div class="col-md-3 col-md-offset-3 xs-mb-15">
                  <img src="https://cdn.ersnet.org/images/people/leadership/Leo-Heunks.png" width="120" height="120" class="img-circle">
            ...
            <div class="col-md-6 center-block">
              <p >Assembly Early Career representative: Maxime Patout</p>
            </div>
            ...
            <div class="row　row_assemblies_cardclearfix">
                ...
                <div class="col-md-4">
                  <div class="card card-padded">
                    ...
                    <div class="card-title text-left">
                      <h3>Noninvasive Ventilatory Support</h3>
                    </div> 
                    <div class="card-content text-left">
                      <p>Group 02.02<br>
                      Chair: João Carlos Winck Fernandes Cruz<br>
                      Secretary: Marieke L. Duiverman</p>
                    </div>
                    <div class="card-action clearfix">
