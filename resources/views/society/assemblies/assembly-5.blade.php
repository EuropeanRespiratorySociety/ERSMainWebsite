            ...
            <div class="row　row_assemblies_card clearfix">
              <div class="col-md-4">
                <div class="card card-padded">
                  ...
                  <div class="card-content text-left">
                    <p>Group 05.01<br>
                    Chair: {!! Html::mailto('r.gosens@rug.nl', 'Reinoud Gosens') !!}<br>
                    Secretary: {!! Html::mailto('p.kirkham@wlv.ac.uk', 'Paul Kirkham') !!}</p>
              ...
              <div class="col-md-4">
                <div class="card card-padded">
                  ...
                  <div class="card-content text-left">
                    <p>Group 05.02<br>
                    Chair: {!! Html::mailto('lcampos@separ.es', 'Jose Luis Lopez-Campos') !!}<br>
              ...
              <div class="col-md-4">
                <div class="card card-padded">
                  ...
                  <div class="card-content text-left">
                    <p>Group 05.03<br>
                    Chair: {!! Html::mailto('apostolos.bossios@gu.se', 'Apostolos Bossios') !!}<br>
