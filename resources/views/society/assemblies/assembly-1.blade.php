          ...
          <div class="page-head"><h2>ERS Assembly 1: Clinical</h2></div>
            ...
            <div class="row">
                <div class="col-md-3 col-md-offset-3 xs-mb-15">
                  <img src="../images/assemblies/Felix_JF_Herth.jpg" class="img-circle">
                  <p class="photo_caption">Head: <a href="mailto:felix.herth@med.uni-heidelberg.de">Felix JF. Herth</a></p>
                </div>
                <div class="col-md-3 xs-mb-15">
                  <img src="../images/assemblies/Venerino_Poletti.jpg" class="img-circle">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="card card-padded">
                  ...
                  <div class="card-action clearfix">
                    <button data-toggle="modal" data-target="#md-clinical-problems" type="button" class="btn btn-default pull-right">More</button>
              ...
              <div class="col-md-4">
                <div class="card card-padded">
                  ...
                  <div class="card-title text-left">
                    <h3>Rehabilitation and Chronic Care</h3>
                  </div> 
                  <div class="card-content text-left">
                    <p>Group 01.02<br>
