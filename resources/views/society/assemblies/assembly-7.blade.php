          ...
          <div class="page-head"><h2>ERS Assembly 7: Paediatrics </h2></div>
            ...
            <div class="row">
                <div class="col-md-3 col-md-offset-3 xs-mb-15">
                  <img src="../images/stories/people/Fabio_Midulla.jpg" class="img-circle">
                  <p class="photo_caption">Head: <a href="mailto:midulla@uniroma1.it">Fabio Midulla</a></p>
                </div>
                <div class="col-md-3 xs-mb-15">
                  <img src="../images/stories/people/Jonathan_Grigg.jpg" class="img-circle">
            ...
            <div class="row　row_assemblies_card">
              ...
              <div class="col-md-4">
                <div class="card card-padded">
                  ...
                  <div class="card-title text-left">
                    <h3>Paediatric Respiratory Physiology and Sleep</h3>
                  </div> 
              ...
              <div class="col-md-4">
                <div class="card card-padded">
                  ...
                  <div class="card-title text-left">
                    <h3>Paediatric Asthma and Allergy</h3>
                  </div> 
                  <div class="card-content text-left">
                    <p>Group 07.02<br>
              ...
              <div class="col-md-4">
               ...
               <div class="col-md-4">
                <div class="card card-padded">
                  ...
                  <div class="card-title text-left">
                    <h3>Paediatric Respiratory Infection and Immunology</h3>
                  </div> 
                  <div class="card-content text-left">
                    <p>Group 07.04<br>
              ...
              <div class="col-md-4">
                <div class="card card-padded">
                  ...
                  <div class="card-title text-left">
                    <h3>Neonatology and Paediatric Intensive Care</h3>
                  </div> 
                  <div class="card-content text-left">
                    <p>Group 07.05<br>
              ...
              <div class="col-md-4">
                <div class="card card-padded">
                  ...
                  <div class="card-title text-left">
                    <h3>Paediatric Respiratory Epidemiology</h3>
                  </div> 
                  <div class="card-content text-left">
                    <p>Group 07.06<br>
