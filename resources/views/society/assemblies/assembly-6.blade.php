              ...
              <div class="card card-padded">
                ...
                <div class="card-content text-left">
                  ...
                  <div class="card-action clearfix">
                    <button data-toggle="modal" data-target="#md-epidemiology" type="button" class="btn btn-default pull-right">More</button>
              ...
              <div class="col-md-4">
                ...
                <div class="col-md-4">
                  <div class="card card-padded">
                    ...
                    <div class="card-title text-left">
                      <h3>Tobacco, Smoking Control and Health Education</h3>
                    </div> 
                    <div class="card-content text-left">
                      <p>Group 06.03<br>
