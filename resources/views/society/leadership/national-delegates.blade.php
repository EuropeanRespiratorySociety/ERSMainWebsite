...
<div class="ers-content leadership-content">
	<div class="col-md-10">
    	<div class="main-content">
	        <div class="page-head">
	        	<h2 class="">National Delegates 2014-2015</h2>
	        </div>
	        <div class="row" style="padding-top: 30px;">
	        	<div class="col-md-4 national_delegates ">
	         	...
	         	<div class="col-md-4 national_delegates ">
		            ...
		            {!! Html::mailto('wim.janssens@uzleuven.be', 'Wim Janssens') !!}
	         	</div>
	         	<div class="col-md-4 national_delegates ">
	         	...
	         	<div class="col-md-4 national_delegates ">
		            ...
		            {!! Html::mailto('mihovil.roglic@kbc-zagreb.hr', 'Mihovil Roglic') !!}
	         	</div>
	         	<div class="col-md-4 national_delegates ">
	         	...
	         	<div class="col-md-4 national_delegates ">
		            ...
		            {!! Html::mailto('petros44@hotmail.com', 'Petros Bakakos') !!}
	         	</div>
	         	<div class="col-md-4 national_delegates ">
	         	...
	         	<div class="col-md-4 national_delegates ">
		            ...
		            {!! Html::mailto('istrambu@yahoo.com', 'Irina Strambu') !!}
	         	</div>
	         	<div class="col-md-4 national_delegates ">
	         	...
	         	<div class="col-md-4 national_delegates ">
		            ...
		            {!! Html::mailto('lea.leonardis@kclj.si', 'Lea Leonardis') !!}
	         	</div>
	         	<div class="col-md-4 national_delegates ">
	         	...
	         	<div class="col-md-4 national_delegates ">
		            ...
		            {!! Html::mailto('bilung@gmail.com', 'Bilun Gemicioglu') !!}
	         	</div>
	         	<div class="col-md-4 national_delegates ">
