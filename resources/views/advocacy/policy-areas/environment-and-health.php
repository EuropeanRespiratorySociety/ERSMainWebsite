    ...
    <div class="page-head"><h3>Environment and health</h3></div>
	    ...
	    <div class="row">
		    <div class="col-md-8 col-md-offset-2">
		    	<div class="col-md-4">
		    		<div style="font-size:60px"><span id="data400k" class="text-center">400,000</span></div>
		    		<p>premature deaths every year are caused by outdoor air pollution in Europe.</p>
		    	</div>
		    	<div class="col-md-4">
		    		<div style="font-size:60px"><span id="data50bis" class="text-center">50</span><span>%</span></div>
		    		<p>of the world’s population are exposed to indoor air pollution from open fires and wood-burning cooking stoves - causing up to 1.5 million premature deaths globally each year.</p>
		    	</div>
		    	<div class="col-md-4">
		    		<div style="font-size:60px"><span id="data15" class="text-center">15</span>-<span id="data20" class="text-center">20</span><span>%</span></div>
		    		<p>of COPD cases are caused by exposures to airborne pollutants in the workplace.</p>
		    	</div>
		    </div>
		</div>
