            ...
            <div class="article-text" style="margin-bottom: 80px;">
              <div class="main-content">
                ...
                <div class="text-left" style="font-size: 16px;margin: 20px 0 80px; font-family: DinPro,sans-serif; padding:0 35px;">
                  ...
                  <p>
                    The content shared in the COVID-19 Weekly section is gathered from a range of external sources. The European Respiratory Society (ERS) is not responsible for the accuracy of the content published by external sources.
                  </p>
                </div>
              </div>
