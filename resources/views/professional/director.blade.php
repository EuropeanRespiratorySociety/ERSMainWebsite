<div class="courses-director medium-grey-bg col-sm-12 {!! $class !!}">
    <div class="row">
       <div class="col-md-9 col-md-offset-1 xs-mb-15">
            <img src="../images/course/Nicolino_Ambrosino.jpg" class="img-circle" style="margin-top:20px;">
            <p class="photo_caption"><strong>Nicolino Ambrosino</strong> Educational Programmes Director<br></p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">   
