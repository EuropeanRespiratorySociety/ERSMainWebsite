...
var App = (function () {
  ...
  var config = {
    ...
    removeLeftSidebarClass: 'ers-nosidebar-left',
    transitionClass: 'ers-animate',
  ...
  function leftSidebarInit(){
    ...
    /*Nanoscroller when left sidebar is fixed*/
      if( wrapper.hasClass("ers-fixed-sidebar") ){
        ...
        lsc.wrap('<div class="ers-scroller nano"></div>');
  ...
  function rightSidebarInit(){
    ...
    if( rightSidebar.length > 0 ){
      /*Open-Sidebar when click on topbar button*/
      $('.ers-toggle-right-sidebar').on("click", function(e){
  ...
  function chatWidget(){
    var chat = $(".ers-right-sidebar .tab-pane.chat");
    ...
    function openChatWindow(){
      if( !chat.hasClass("chat-opened") ){
        ...
        $(".ers-scroller", messagesContainer).nanoScroller();
      }
    }
    ...
    $(".user a", contactsEl).on('click',function( e ){
      $(".ers-scroller", contactsEl).nanoScroller({ stop: true });
      openChatWindow();
      e.preventDefault();
    });
  ...
  function scrollTopButton(){
    var offset = 220;
    var duration = 500;
    var button = $('<div class="ers-scroll-top"></div>');
    ...
    init: function (options) {
      ...
      /*Bootstrap modal scroll top fix*/
        $('.modal').on('show.bs.modal', function(){
          $("html").addClass('ers-modal-open');
        });

        $('.modal').on('hidden.bs.modal', function(){
          $("html").removeClass('ers-modal-open');
        });
    },
