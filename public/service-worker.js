...
toolbox.router.get(/^https:\/\/new\.ersnet\.org\//, toolbox.networkFirst, {"cache":{"name":"european-respiratory-offline-pages"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/who-we-are/, toolbox.cacheFirst, {"cache":{"name":"european-respiratory-offline-pages-who-we-are"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/who-we-are\/leadership/, toolbox.cacheFirst, {"cache":{"name":"european-respiratory-offline-pages-leadership"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/who-we-are\/executive-office/, toolbox.cacheFirst, {"cache":{"name":"european-respiratory-offline-pages-executive-office"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/who-we-are\/statutes-policies-and-annual-report/, toolbox.cacheFirst, {"cache":{"name":"european-respiratory-offline-pages-satutes-policies"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/who-we-are\/awards/, toolbox.cacheFirst, {"cache":{"name":"european-respiratory-offline-pages-awards"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/who-we-are\/fellow-of-ers/, toolbox.cacheFirst, {"cache":{"name":"european-respiratory-offline-pages-fellows"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/membership/, toolbox.cacheFirst, {"cache":{"name":"european-respiratory-offline-pages-membersip"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/assemblies/, toolbox.cacheFirst, {"cache":{"name":"european-respiratory-offline-pages-assemblies"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/news\/respiratory-world-wide/, toolbox.networkFirst, {"cache":{"name":"european-respiratory-offline-pages-rww"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/news\/respiratory-matters/, toolbox.networkFirst, {"cache":{"name":"european-respiratory-offline-pages-rm"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/news\/press-office/, toolbox.cacheFirst, {"cache":{"name":"european-respiratory-offline-pages-press"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/news\/contact/, toolbox.cacheFirst, {"cache":{"name":"european-respiratory-offline-pages-contact"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/news/, toolbox.networkFirst, {"cache":{"maxEntries":10,"name":"european-respiratory-offline-pages-news"}});
