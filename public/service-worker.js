...
toolbox.router.get(/^https:\/\/new\.ersnet\.org\//, toolbox.networkFirst, {"cache":{"name":"ers-offline-pages"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/who-we-are/, toolbox.cacheFirst, {"cache":{"name":"ers-offline-pages-who-we-are"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/who-we-are\/leadership/, toolbox.cacheFirst, {"cache":{"name":"ers-offline-pages-leadership"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/who-we-are\/executive-office/, toolbox.cacheFirst, {"cache":{"name":"ers-offline-pages-executive-office"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/who-we-are\/statutes-policies-and-annual-report/, toolbox.cacheFirst, {"cache":{"name":"ers-offline-pages-satutes-policies"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/who-we-are\/awards/, toolbox.cacheFirst, {"cache":{"name":"ers-offline-pages-awards"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/who-we-are\/fellow-of-ers/, toolbox.cacheFirst, {"cache":{"name":"ers-offline-pages-fellows"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/membership/, toolbox.cacheFirst, {"cache":{"name":"ers-offline-pages-membersip"}});
toolbox.router.get(/^https:\/\/new\.ersnet\.org\/the-society\/assemblies/, toolbox.cacheFirst, {"cache":{"name":"ers-offline-pages-assemblies"}});
